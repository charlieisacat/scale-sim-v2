...
class double_buffered_scratchpad:
    def __init__(self):
        ...
        self.ifmap_trace_matrix = np.zeros((1,1), dtype=np.int32)
        self.filter_trace_matrix = np.zeros((1,1), dtype=np.int32)
        self.ofmap_trace_matrix = np.zeros((1,1), dtype=np.int32)
